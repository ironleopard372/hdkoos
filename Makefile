...
HDK		:= /home/holyangel/android/Toolchains/sdclang-4.9.4/
HDK_TC		:= /home/holyangel/android/Toolchains/sdclang-4.9.4/bin/
ARCH		:= arm64
SUBARCH		:= arm64
...
HOSTCXXFLAGS = -O2 $(GEN_OPT_FLAGS) -fdeclone-ctor-dtor

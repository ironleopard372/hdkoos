...
# Source Path to kernel tree
	k=/home/holyangel/android/op6

# Source Path to clean(empty) out folder
	co=$k/out

# Compile Path to out 
	o="O=/home/holyangel/android/op6/out"
...
# Destination path for compiled Image.gz-dtb
	zi=$k/build/kernel/Image.lz4-dtb
...
############################################################
	...
	rm -Rf out/
	rm -f build/kernel/Image.gz-dtb
	rm -f build/kernel/Image.lz4-dtb
